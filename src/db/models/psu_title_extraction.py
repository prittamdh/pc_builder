"""Per-listing Power Supply identity extraction table. See cpu_title_extraction.py for the pattern."""
...
class PSUTitleExtraction(Base, TimestampMixin):
    __tablename__ = "psu_title_extractions"
    ...
    efficiency_rating: Mapped[str | None] = mapped_column(String(20))
