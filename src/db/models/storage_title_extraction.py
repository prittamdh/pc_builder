"""Per-listing Storage identity extraction table. See cpu_title_extraction.py for the pattern."""
...
class StorageTitleExtraction(Base, TimestampMixin):
    __tablename__ = "storage_title_extractions"
    ...
    interface: Mapped[str | None] = mapped_column(String(20))
