"""Per-listing CPU Cooler identity extraction table. See cpu_title_extraction.py for the pattern."""
...
class CoolerTitleExtraction(Base, TimestampMixin):
    __tablename__ = "cooler_title_extractions"
    ...
    cooler_type: Mapped[str | None] = mapped_column(String(20))
    size_mm: Mapped[int | None] = mapped_column(Integer)
