"""Per-listing Cabinet/Case identity extraction table. See cpu_title_extraction.py for the pattern."""
...
class CabinetTitleExtraction(Base, TimestampMixin):
    __tablename__ = "cabinet_title_extractions"
    ...
    form_factor: Mapped[str | None] = mapped_column(String(100))
