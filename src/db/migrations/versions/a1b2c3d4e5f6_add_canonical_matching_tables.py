...
def upgrade() -> None:
    """Upgrade schema to include canonical matching tables."""
    ...
    # 2. Create canonical_parts table
    op.create_table(
        'canonical_parts',
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_canonical_parts_status'), table_name='canonical_parts')
    op.drop_index(op.f('ix_canonical_parts_chipset_id'), table_name='canonical_parts')
    op.drop_index(op.f('ix_canonical_parts_brand'), table_name='canonical_parts')
    op.drop_index(op.f('ix_canonical_parts_category'), table_name='canonical_parts')
    op.drop_table('canonical_parts')

    op.drop_index(op.f('ix_chipset_specs_category'), table_name='chipset_specs')
